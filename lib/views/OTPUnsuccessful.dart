...
class OTPUnsuccessful extends StatelessWidget {
  OTPUnsuccessful({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(-311.54.w, -61.72.h),
            child:
          ...
          Transform.translate(
            offset: Offset(121.0.w, 252.91.h),
            child:
                // Adobe XD layer: 'iconfinder_Incorrec…' (group)
                Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(0.0.w, 0.09.h),
                  child:
                      // Adobe XD layer: 'Incorrect_Symbol_1_' (group)
                      Stack(
                    children: <Widget>[
                      // Adobe XD layer: 'Incorrect_Symbol' (group)
                      Stack(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: const Color(0xccff3939),
                            ),
                          ),
                          Transform.translate(
                            offset: Offset(10.27.w, 10.87.h),
                            child:
                                // Adobe XD layer: 'Cross_x5F_Symbol' (shape)
                                SvgPicture.string(
                              _svg_q50er2,
                              allowDrawingOutsideViewBox: true,
                            ),
...
const String _svg_q50er2 =
    '<svg viewBox="10.3 10.9 30.2 28.2" ><path transform="translate(2.27, 2.87)" d="M 38.20589065551758 11.70202255249023 L 34.24137115478516 7.999999523162842 L 23.10294532775879 18.40092086791992 L 11.96452236175537 7.999999523162842 L 7.999999523162842 11.70202255249023 L 19.1384220123291 22.10294532775879 L 7.999999523162842 32.50387191772461 L 11.96452236175537 36.20589065551758 L 23.10294532775879 25.80496788024902 L 34.24137115478516 36.20589065551758 L 38.20589065551758 32.50387191772461 L 27.06746864318848 22.10294532775879 L 38.20589065551758 11.70202255249023 Z" fill="#e6e6e6" fill-opacity="0.8" stroke="none" stroke-width="1" stroke-opacity="0.8" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
